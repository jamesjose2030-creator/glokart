...
import { View, Product, Category, Currency, User, Offer } from './types';
...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Disc edition. Comes with 2 controllers and FIFA 24. Slight scratch on the side panel but works perfectly.',
    price: 1500,
    currency: Currency.AED,
    category: Category.ELECTRONICS,
    ...
    sellerName: 'GameZone Trader',
    postedDate: '5 hours ago',
    condition: 'Good',
    tags: ['gaming', 'ps5', 'sony'],
    isSold: false,
    status: 'approved',
    details: {
      brand: 'Sony',
      specifications: 'Disc Edition'
    },
    offers: []
  }
];
...
const App: React.FC = () => {
  ...
  // Persistent State: Current Session
